# Engineering audit knowledge

This file is always in context. Apply the invariants below to all code you
review, audit, or generate. Detailed per-topic checklists live in
`.agents/skills/audit/references/` — read the matching file (map at the bottom)
before doing an in-depth audit.
